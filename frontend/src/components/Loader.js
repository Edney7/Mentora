...
const StyledWrapper = styled.div`
  /* A partir daqui, todo o CSS que você enviou */
  .pencil {
    display: block;
    width: 10em;
    height: 10em;
    margin: auto; /* Adicionado para ajudar na centralização */
  }
  
  /* ... resto do seu CSS de animação ... */
  /* (copie e cole todo o bloco de CSS aqui) */
