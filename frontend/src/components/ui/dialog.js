...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // AQUI ESTÁ A MUDANÇA: 'bg-background' foi trocado por 'bg-white' para garantir o fundo branco sólido.
        ...
        // Nossos ajustes de responsividade (mantidos)
...
const DialogHeader = ({ className, ...props }) => (
  <div
    className={cn("flex flex-col space-y-1.5 text-center sm:text-left border-b pb-4", className)}
    {...props}
  />
)
