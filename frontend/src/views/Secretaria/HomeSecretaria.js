...
export default function HomeSecretaria() {
  ...
  const carregarDadosDaPagina = useCallback(async () => {
    ...
    try {
      ...
      const formatados = eventosData.map(ev => ({ title: ev.titulo, date: ev.data }));
      ...
      <section className="event-panel"> 
        ...
        <div className="event-group">
          ...
          <Modal isOpen={modalAberto} onClose={fecharModal} contentLabel="Cadastrar Evento">
            ...
            <input type="text" placeholder="Título" value={novoEvento.titulo} onChange={(e) => setNovoEvento(prev => ({ ...prev, titulo: e.target.value }))} />
            <input type="text" placeholder="Descrição" value={novoEvento.descricao} onChange={(e) => setNovoEvento(prev => ({ ...prev, descricao: e.target.value }))} />
            <input type="date" value={novoEvento.data} onChange={(e) => setNovoEvento(prev => ({ ...prev, data: e.target.value }))} />
            <input type="text" placeholder="Tipo" value={novoEvento.tipo} onChange={(e) => setNovoEvento(prev => ({ ...prev, tipo: e.target.value }))} />
